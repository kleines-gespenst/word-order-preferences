...
def create_splits(sample_file, num_splits, train, test, dev, output_folder):
    ...
    # For files like: sample_OSV_s2False_s3False_s4False_s5False_s6False.txt
    # Extract: OSV_s2False_s3False_s4False_s5False_s6False
    filename = os.path.basename(sample_file)
    grammar_name = filename.replace("sample_", "").replace(".txt", "")
